document.addEventListener('DOMContentLoaded', () => {
    ...
    registerForm.querySelector('form').addEventListener('submit', (e) => {
        ...
        if (firstName && lastName && phone && email && password) {
            ...
            // In a real application, you'd send this to a server for registration.
            // After successful registration, you might automatically log them in or ask them to login.
    ...
    // Placeholder for 3D cube animation (requires Three.js or similar library)
    // You would typically initialize Three.js here to create and animate the cube
    // const scene = new THREE.Scene();
    // const camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 1000);
    // const renderer = new THREE.WebGLRenderer({ antialias: true, alpha: true });
    // renderer.setSize(window.innerWidth, window.innerHeight);
    // document.getElementById('cube-background').appendChild(renderer.domElement);
